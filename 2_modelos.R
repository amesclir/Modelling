...
setwd("/home/amesclir/Documents/Ubuntufiles/GITHUB/Modelling")
...
plotmo(m.gam.ausencia, type="response")
plotmo(m.gam.pseudoausencia, type="response")
#¿CREES QUE TIENEN MÁS SENTIDO QUE LAS ANTERIORES?
...
fichero<-"/home/amesclir/Documents/Ubuntufiles/GITHUB/Modelling/maxent/maxent.jar"
...
writeRaster(mapa.escalado, filename="./resultados/modelos/maxent2.asc", format="ascii", overwrite=TRUE)
